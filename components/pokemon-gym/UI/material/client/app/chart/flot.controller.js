        ...
        $scope.searchDB = function(){
            ...
            $http({
              ...
              data: {
                ...
                // $scope.combo3.data[0].data = res.data;

                // console.log($scope.combo3.data[0].data);
                ...
                for (var i = 0; i < res.data.length; i++) { 
                    ...
                    $scope.labels.push(res.data[i][0]);
                ...
                console.log('dddd ',$scope.data);
                //$scope.$apply();

                $scope.series = ['All Searches'];
