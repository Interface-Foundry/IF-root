...
JobRunner.prototype.run = function() {
    ...
    db.findOne({
        ...
        if (!doc) {
            console.log('no doc found for job ' + me.opts.name + ' - waiting for ' + me.opts.currentColdWaitPeriod + 'milliseconds');
            ...
            console.log('found doc for job ' + me.opts.name);
            ...
            doc.save(function(e) {
	            ...
	            db.remove({'flags.complete': true}, function () {	
                try {
