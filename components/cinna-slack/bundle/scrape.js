 ...
 */
// var url1 = 'https://www.amazon.com/gp/p13n-shared/faceout-partial?featureId=SimilaritiesCarousel&reftagPrefix=pd_sim_201&widgetTemplateClass=PI%3A%3ASimilarities%3A%3AViewTemplates%3A%3ACarousel%3A%3ADesktop&imageHeight=160&faceoutTemplateClass=PI%3A%3AP13N%3A%3AViewTemplates%3A%3AProduct%3A%3ADesktop%3A%3ACarouselFaceout&auiDeviceType=desktop&imageWidth=160&schemaVersion=2&productDetailsTemplateClass=PI%3A%3AP13N%3A%3AViewTemplates%3A%3AProductDetails%3A%3ADesktop%3A%3ABase&relatedRequestID=PKJQGYFNCVRWH533MQE4&maxLineCount=6&count=5&offset=10&asins=B000BO58PC%2CB000MFAOPY%2CB004HIAT2K%2CB00FXOFM6U%2CB004ND5FGY&_=1467829095118'
var url1 = 'https://www.amazon.com/gp/p13n-shared/faceout-partial?featureId=SimilaritiesCarousel&reftagPrefix=pd_sim_201&widgetTemplateClass=PI%3A%3ASimilarities%3A%3AViewTemplates%3A%3ACarousel%3A%3ADesktop&imageHeight=160&faceoutTemplateClass=PI%3A%3AP13N%3A%3AViewTemplates%3A%3AProduct%3A%3ADesktop%3A%3ACarouselFaceout&auiDeviceType=desktop&imageWidth=160&schemaVersion=2&productDetailsTemplateClass=PI%3A%3AP13N%3A%3AViewTemplates%3A%3AProductDetails%3A%3ADesktop%3A%3ABase&relatedRequestID=PKJQGYFNCVRWH533MQE4&maxLineCount=6&count=5&offset=30&asins=B00MZSHX6Y%2CB003K1RAJK%2CB00178HJ6C%2CB00534FNB4%2CB0030DF8PG&_=1467828970997'
var url = 'https://www.amazon.com/dp/B00B4BJZ9G/ref=nav_timeline_asin?_encoding=UTF8&psc=1'
 ...
 proxiedRequest.get(url, function(err, response, body) {
  ...
  // console.log(body)
   ...
   //sort scraped price
   // find the customers who viewed this item also viewed
   var asin_list;
  ...
  // count the remaining urls to visit
  ...
  {
    if (i + 1 == 15)
      request_url += asin_list[i];
    else
      request_url += asin_list[i] + '%2C';
  }
  ...
  function proxyRequest(url)
  {
    ...
    $(' div').each(function(i, elem) {
      ...
      if ($(this).attr('class') == '\\"p13n-sc-truncate') {
        ...
        alsoBought.push(productName.slice(0, productName.length - 2));
