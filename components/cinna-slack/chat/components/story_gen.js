...
var survey = require('./stories/survey_templates/survey2.js')
var db = require('db');
var Story = db.Story;
...
app.get('/slackauth', function(req, res) {
    ...
    //https://slack.com/oauth/pick_reflow?scope=commands+bot+users%3Aread&client_id=72990018007.73068183056
   ...
   // console.log('REQ ',req)
    ...
    var clientID = '72990018007.73068183056';
    var clientSecret = 'c1bb7a90eb5f148fcaa80566ca7b7305';
    var redirect_uri = 'https://75288648.ngrok.io/slackauth';
