...
export default class SlackWhite extends Component {
  render() {
    return (
      <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"viewBox="60 60 150 150" enableBackground="new 0 0 140 140" xmlSpace="preserve">
        <g id="Layer_1_1_">
        </g>
        <g id="Layer_3">
        </g>
        ...
        <g id="Layer_2">
          <g>
              ...
              <rect x="128.5" y="127.3" transform="matrix(0.9482 -0.3176 0.3176 0.9482 -36.0197 50.6366)" className="st0" width="17.6" height="17"/>
            <g>
              
                <rect x="128.5" y="127.3" transform="matrix(0.9482 -0.3176 0.3176 0.9482 -36.0197 50.6366)" className="st0" width="17.6" height="17"/>
              <path className="st0" d="M194.6,118.5c-12.9-43-31.5-53-74.5-40.1s-53,31.5-40.1,74.5s31.5,53,74.5,40.1S207.5,161.5,194.6,118.5z
