...
3. Download a secret key from Google Credentials in .json format (maybe there's a better way to do this?): https://console.cloud.google.com/apis/credentials?project=kip-styles
