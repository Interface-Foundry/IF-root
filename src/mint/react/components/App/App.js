...
export default class App extends Component {
  ...
  render() {
    ...
    const { cart_id, newAccount, leader, carts, match, currentUser, location, logout, items, history: { replace } } = props;
    const { sidenav } = state;
    ...
    return (
      <section className='app'>
        ...
        { sidenav ? <Sidenav cart_id={cart_id} logout={logout} leader={leader} carts={carts} _toggleSidenav={_toggleSidenav} currentUser={currentUser} replace={replace} itemsLen={items.length} /> : null }
