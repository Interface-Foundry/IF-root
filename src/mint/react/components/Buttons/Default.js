...
export default class Default extends Component {
  ...
  _orderCart = (e) => {
    const { cart: { locked, store, id, leader }, user, reorderCart, toggleYpoCheckout, updateCart, selectTab } = this.props;
  ...
  render() {
    const {
      props: { cart, user, updateCart, selectTab, tab, checkoutOnly = false }
    } = this,
        ...
        <span>
            {
              ...
              :
                (
                  tab === 'invoice' ? <button className='yellow sub' onClick={::this._orderCart}>
                  ...
                  </button> : <button className='yellow sub' onClick={() => selectTab('invoice')}>
