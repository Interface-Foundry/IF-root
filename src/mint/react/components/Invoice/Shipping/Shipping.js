...
export default class Shipping extends Component {
    ...
    render() {
        ...
        return (
        	<div className='shipping accordion' onClick={() => selectAccordion('shipping')}>
        		<nav>
        			<h3>1. Shipping address</h3>
                    {
                        selectedIndex !== null && selectedAccordion !== 'shipping' ? <div className='text'> 
        		...
        		{
        			selectedAccordion === 'shipping' ? <div> 
        				<nav>
