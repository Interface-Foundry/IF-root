...
const message = {
  ...
  "attachments": [{
    "text": "",
    "pretext":"It\'s Admin Appreciation Week! Thank team members who keep the office running smoothly\n Take this short quiz to find out what to get 🎉",
    "image_url": "https://storage.googleapis.com/kip-random/bloomthat_quiz/quiz_1.png",
    "mrkdwn_in": ["text,pretext"],
    "fallback": "It\'s Admin Appreciation Week! Thank team members who keep the office running smoothly\n Take this short quiz to find out what to get 🎉",
    "callback_id": "none",
    "color":"#52A2F0",
            ...
            if(i.user == u.id){
              ...
              if(userHistory && userHistory.messages && userHistory.messages.length > 0){
                ...
                if(s.indexOf('Admin Day') > -1 ||
                   s.indexOf('Admin Appreciation Week ') > -1 ||
