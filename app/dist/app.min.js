...
}},bing:{mustHaveUrl:!1,createLayer:function(a){return Helpers.BingLayerPlugin.isLoaded()?new L.BingLayer(a.key,a.options):void 0}},heatmap:{mustHaveUrl:!1,mustHaveData:!0,createLayer:function(a){if(Helpers.HeatMapLayerPlugin.isLoaded()){var b=new L.TileLayer.WebGLHeatMap(a.options);return isDefined(a.data)&&b.setData(a.data),b}}},yandex:{mustHaveUrl:!1,createLayer:function(a){var b=a.type||"map";if(Helpers.YandexLayerPlugin.isLoaded())return new L.Yandex(b,a.options)}},imageOverlay:{mustHaveUrl:!0,mustHaveBounds:!0,createLayer:function(a){return L.imageOverlay(a.url,a.bounds,a.options)}},custom:{createLayer:function(a){return a.layer instanceof L.Class?angular.copy(a.layer):void $log.error("[AngularJS - Leaflet] A custom layer must be a leaflet Class")}},cartodb:{mustHaveUrl:!0,createLayer:function(a){return cartodb.createLayer(a.map,a.url)}}};return{createLayer:function(a){if(isValidLayerType(a)){if(!isString(a.name))return void $log.error("[AngularJS - Leaflet] A base layer must have a name");isObject(a.layerParams)||(a.layerParams={}),isObject(a.layerOptions)||(a.layerOptions={});for(var b in a.layerParams)a.layerOptions[b]=a.layerParams[b];var c={url:a.url,data:a.data,options:a.layerOptions,layer:a.layer,type:a.layerType,bounds:a.bounds,key:a.key,pluginOptions:a.pluginOptions,user:a.user};return layerTypes[a.type].createLayer(c)}}}}]),angular.module("leaflet-directive").factory("leafletControlHelpers",["$rootScope","$log","leafletHelpers","leafletMapDefaults",function(a,b,c,d){var e,f=c.isObject,g=c.isDefined,h=function(a,b,c){var e=d.getDefaults(c);if(!e.controls.layers.visible)return!1;var g=0;return f(a)&&(g+=Object.keys(a).length),f(b)&&(g+=Object.keys(b).length),g>1},i=function(a){var b=d.getDefaults(a),c={collapsed:b.controls.layers.collapsed,position:b.controls.layers.position};angular.extend(c,b.controls.layers.options);var e;return e=b.controls.layers&&g(b.controls.layers.control)?b.controls.layers.control.apply(this,[[],[],c]):new L.control.layers([],[],c)};return{layersControlMustBeVisible:h,updateLayersControl:function(a,b,c,d,f,j){var k,l=h(d,f,b);if(g(e)&&c){for(k in j.baselayers)e.removeLayer(j.baselayers[k]);for(k in j.overlays)e.removeLayer(j.overlays[k]);e.removeFrom(a)}if(l){e=i(b);for(k in d)g(j.baselayers[k])&&e.addBaseLayer(j.baselayers[k],d[k].name);for(k in f)g(j.overlays[k])&&e.addOverlay(j.overlays[k],f[k].name);e.addTo(a)}return l}}}]),angular.module("leaflet-directive").factory("leafletLegendHelpers",function(){var a=function(a,b){if(a.innerHTML="",b.error)a.innerHTML+='<div class="info-title alert alert-danger">'+b.error.message+"</div>";else for(var c=0;c<b.layers.length;c++){var d=b.layers[c];a.innerHTML+='<div class="info-title" data-layerid="'+d.layerId+'">'+d.layerName+"</div>";for(var e=0;e<d.legend.length;e++){var f=d.legend[e];a.innerHTML+='<div class="inline" data-layerid="'+d.layerId+'"><img src="data:'+f.contentType+";base64,"+f.imageData+'" /></div><div class="info-label" data-layerid="'+d.layerId+'">'+f.label+"</div>"}}},b=function(b,c){return function(){var d=L.DomUtil.create("div",c);return L.Browser.touch?L.DomEvent.on(d,"click",L.DomEvent.stopPropagation):(L.DomEvent.disableClickPropagation(d),L.DomEvent.on(d,"mousewheel",L.DomEvent.stopPropagation)),a(d,b),d}},c=function(a,b){return function(){for(var c=L.DomUtil.create("div",b),d=0;d<a.colors.length;d++)c.innerHTML+='<div class="outline"><i style="background:'+a.colors[d]+'"></i></div><div class="info-label">'+a.labels[d]+"</div>";return L.Browser.touch?L.DomEvent.on(c,"click",L.DomEvent.stopPropagation):(L.DomEvent.disableClickPropagation(c),L.DomEvent.on(c,"mousewheel",L.DomEvent.stopPropagation)),c}};return{getOnAddArcGISLegend:b,getOnAddArrayLegend:c,updateArcGISLegend:a}}),angular.module("leaflet-directive").factory("leafletPathsHelpers",["$rootScope","$log","leafletHelpers",function(a,b,c){function d(a){return a.filter(function(a){return k(a)}).map(function(a){return new L.LatLng(a.lat,a.lng)})}function e(a){return new L.LatLng(a.lat,a.lng)}function f(a){return a.map(function(a){return d(a)})}function g(a,b){for(var c={},d=0;d<l.length;d++){var e=l[d];h(a[e])?c[e]=a[e]:h(b.path[e])&&(c[e]=b.path[e])}return c}var h=c.isDefined,i=c.isArray,j=c.isNumber,k=c.isValidPoint,l=["stroke","weight","color","opacity","fill","fillColor","fillOpacity","dashArray","lineCap","lineJoin","clickable","pointerEvents","className","smoothFactor","noClip"],m=function(a,b){for(var c={},d=0;d<l.length;d++){var e=l[d];h(b[e])&&(c[e]=b[e])}a.setStyle(b)},n=function(a){if(!i(a))return!1;for(var b=0;b<a.length;b++){var c=a[b];if(!k(c))return!1}return!0},o={polyline:{isValid:function(a){var b=a.latlngs;return n(b)},createPath:function(a){return new L.Polyline([],a)},setPath:function(a,b){a.setLatLngs(d(b.latlngs)),m(a,b)}},multiPolyline:{isValid:function(a){var b=a.latlngs;if(!i(b))return!1;for(var c in b){var d=b[c];if(!n(d))return!1}return!0},createPath:function(a){return new L.multiPolyline([[[0,0],[1,1]]],a)},setPath:function(a,b){a.setLatLngs(f(b.latlngs)),m(a,b)}},polygon:{isValid:function(a){var b=a.latlngs;return n(b)},createPath:function(a){return new L.Polygon([],a)},setPath:function(a,b){a.setLatLngs(d(b.latlngs)),m(a,b)}},multiPolygon:{isValid:function(a){var b=a.latlngs;if(!i(b))return!1;for(var c in b){var d=b[c];if(!n(d))return!1}return!0},createPath:function(a){return new L.MultiPolygon([[[0,0],[1,1],[0,1]]],a)},setPath:function(a,b){a.setLatLngs(f(b.latlngs)),m(a,b)}},rectangle:{isValid:function(a){var b=a.latlngs;if(!i(b)||2!==b.length)return!1;for(var c in b){var d=b[c];if(!k(d))return!1}return!0},createPath:function(a){return new L.Rectangle([[0,0],[1,1]],a)},setPath:function(a,b){a.setBounds(new L.LatLngBounds(d(b.latlngs))),m(a,b)}},circle:{isValid:function(a){var b=a.latlngs;return k(b)&&j(a.radius)},createPath:function(a){return new L.Circle([0,0],1,a)},setPath:function(a,b){a.setLatLng(e(b.latlngs)),h(b.radius)&&a.setRadius(b.radius),m(a,b)}},circleMarker:{isValid:function(a){var b=a.latlngs;return k(b)&&j(a.radius)},createPath:function(a){return new L.CircleMarker([0,0],a)},setPath:function(a,b){a.setLatLng(e(b.latlngs)),h(b.radius)&&a.setRadius(b.radius),m(a,b)}}},p=function(a){var b={};return a.latlngs&&(b.latlngs=a.latlngs),a.radius&&(b.radius=a.radius),b};return{setPathOptions:function(a,b,c){h(b)||(b="polyline"),o[b].setPath(a,c)},createPath:function(a,c,d){h(c.type)||(c.type="polyline");var e=g(c,d),f=p(c);return o[c.type].isValid(f)?o[c.type].createPath(e):void b.error("[AngularJS - Leaflet] Invalid data passed to the "+c.type+" path")}}}]),angular.module("leaflet-directive").factory("leafletBoundsHelpers",["$log","leafletHelpers",function(a,b){function c(a){return angular.isDefined(a)&&angular.isDefined(a.southWest)&&angular.isDefined(a.northEast)&&angular.isNumber(a.southWest.lat)&&angular.isNumber(a.southWest.lng)&&angular.isNumber(a.northEast.lat)&&angular.isNumber(a.northEast.lng)}var d=b.isArray,e=b.isNumber;return{createLeafletBounds:function(a){return c(a)?L.latLngBounds([a.southWest.lat,a.southWest.lng],[a.northEast.lat,a.northEast.lng]):void 0},isValidBounds:c,createBoundsFromArray:function(b){return d(b)&&2===b.length&&d(b[0])&&d(b[1])&&2===b[0].length&&2===b[1].length&&e(b[0][0])&&e(b[0][1])&&e(b[1][0])&&e(b[1][1])?{northEast:{lat:b[0][0],lng:b[0][1]},southWest:{lat:b[1][0],lng:b[1][1]}}:void a.error("[AngularJS - Leaflet] The bounds array is not valid.")}}}]),angular.module("leaflet-directive").factory("leafletMarkersHelpers",["$rootScope","leafletHelpers","$log",function(a,b,c){var d=b.isDefined,e=b.MarkerClusterPlugin,f=b.AwesomeMarkersPlugin,g=b.MakiMarkersPlugin,h=b.safeApply,i=b,j=b.isString,k=b.isNumber,l=b.isObject,m={},n=function(a){if(d(a)&&d(a.type)&&"awesomeMarker"===a.type)return f.isLoaded()||c.error("[AngularJS - Leaflet] The AwesomeMarkers Plugin is not loaded."),new L.AwesomeMarkers.icon(a);if(d(a)&&d(a.type)&&"makiMarker"===a.type)return g.isLoaded()||c.error("[AngularJS - Leaflet] The MakiMarkers Plugin is not loaded."),new L.MakiMarkers.icon(a);if(d(a)&&d(a.type)&&"div"===a.type)return new L.divIcon(a);var b="data:image/png;base64,",e="data:image/png;base64,";return d(a)?(d(a.iconUrl)||(a.iconUrl=b,a.shadowUrl=e),new L.Icon(a)):new L.Icon.Default({iconUrl:b,shadowUrl:e})},o=function(a){d(m[a])&&m.splice(a,1)},p=function(){m={}},q=function(a,b,c){if(a.closePopup(),d(c)&&d(c.overlays))for(var e in c.overlays)if((c.overlays[e]instanceof L.LayerGroup||c.overlays[e]instanceof L.FeatureGroup)&&c.overlays[e].hasLayer(a))return void c.overlays[e].removeLayer(a);if(d(m))for(var f in m)m[f].hasLayer(a)&&m[f].removeLayer(a);b.hasLayer(a)&&b.removeLayer(a)};return{resetMarkerGroup:o,resetMarkerGroups:p,deleteMarker:q,createMarker:function(a){if(!d(a))return void c.error("[AngularJS - Leaflet] The marker definition is not valid.");var b={icon:n(a.icon),title:d(a.title)?a.title:"",draggable:d(a.draggable)?a.draggable:!1,clickable:d(a.clickable)?a.clickable:!0,riseOnHover:d(a.riseOnHover)?a.riseOnHover:!1,zIndexOffset:d(a.zIndexOffset)?a.zIndexOffset:0,iconAngle:d(a.iconAngle)?a.iconAngle:0};for(var e in a)a.hasOwnProperty(e)&&!b.hasOwnProperty(e)&&(b[e]=a[e]);var f=new L.marker(a,b);return j(a.message)||f.unbindPopup(),f},addMarkerToGroup:function(a,b,f,g){return j(b)?e.isLoaded()?(d(m[b])||(m[b]=new L.MarkerClusterGroup(f),g.addLayer(m[b])),void m[b].addLayer(a)):void c.error("[AngularJS - Leaflet] The MarkerCluster plugin is not loaded."):void c.error("[AngularJS - Leaflet] The marker group you have specified is invalid.")},listenMarkerEvents:function(a,b,c){a.on("popupopen",function(){h(c,function(){b.focus=!0})}),a.on("popupclose",function(){h(c,function(){b.focus=!1})})},addMarkerWatcher:function(a,b,e,f,g){var h=e.$watch("markers."+b,function(b,e){if(!d(b))return q(a,g,f),void h();if(d(e)){if(!k(b.lat)||!k(b.lng))return c.warn("There are problems with lat-lng data, please verify your marker model"),void q(a,g,f);if(j(b.layer)||j(e.layer)&&(d(f.overlays[e.layer])&&f.overlays[e.layer].hasLayer(a)&&(f.overlays[e.layer].removeLayer(a),a.closePopup()),g.hasLayer(a)||g.addLayer(a)),j(b.layer)&&e.layer!==b.layer){if(j(e.layer)&&d(f.overlays[e.layer])&&f.overlays[e.layer].hasLayer(a)&&f.overlays[e.layer].removeLayer(a),a.closePopup(),g.hasLayer(a)&&g.removeLayer(a),!d(f.overlays[b.layer]))return void c.error("[AngularJS - Leaflet] You must use a name of an existing layer");var m=f.overlays[b.layer];if(!(m instanceof L.LayerGroup||m instanceof L.FeatureGroup))return void c.error('[AngularJS - Leaflet] A marker can only be added to a layer of type "group" or "featureGroup"');m.addLayer(a),g.hasLayer(a)&&b.focus===!0&&a.openPopup()}if(b.draggable!==!0&&e.draggable===!0&&d(a.dragging)&&a.dragging.disable(),b.draggable===!0&&e.draggable!==!0&&(a.dragging?a.dragging.enable():L.Handler.MarkerDrag&&(a.dragging=new L.Handler.MarkerDrag(a),a.options.draggable=!0,a.dragging.enable())),l(b.icon)||l(e.icon)&&(a.setIcon(n()),a.closePopup(),a.unbindPopup(),j(b.message)&&a.bindPopup(b.message,b.popupOptions)),l(b.icon)&&l(e.icon)&&!angular.equals(b.icon,e.icon)){var o=!1;a.dragging&&(o=a.dragging.enabled()),a.setIcon(n(b.icon)),o&&a.dragging.enable(),a.closePopup(),a.unbindPopup(),j(b.message)&&a.bindPopup(b.message,b.popupOptions)}!j(b.message)&&j(e.message)&&(a.closePopup(),a.unbindPopup()),i.LabelPlugin.isLoaded()&&d(b.label)&&d(b.label.message)&&!angular.equals(b.label.message,e.label.message)&&a.updateLabelContent(b.label.message),j(b.message)&&!j(e.message)&&(a.bindPopup(b.message,b.popupOptions),b.focus===!0&&a.openPopup()),j(b.message)&&j(e.message)&&b.message!==e.message&&a.setPopupContent(b.message);var p=!1;b.focus!==!0&&e.focus===!0&&(a.closePopup(),p=!0),b.focus===!0&&e.focus!==!0&&(a.openPopup(),p=!0),e.focus===!0&&b.focus===!0&&(a.openPopup(),p=!0),e.zIndexOffset!==b.zIndexOffset&&a.setZIndexOffset(b.zIndexOffset);var r=a.getLatLng(),s=j(b.layer)&&i.MarkerClusterPlugin.is(f.overlays[b.layer]);s?p?(b.lat!==e.lat||b.lng!==e.lng)&&(f.overlays[b.layer].removeLayer(a),a.setLatLng([b.lat,b.lng]),f.overlays[b.layer].addLayer(a)):r.lat!==b.lat||r.lng!==b.lng?(f.overlays[b.layer].removeLayer(a),a.setLatLng([b.lat,b.lng]),f.overlays[b.layer].addLayer(a)):(b.lat!==e.lat||b.lng!==e.lng)&&(f.overlays[b.layer].removeLayer(a),a.setLatLng([b.lat,b.lng]),f.overlays[b.layer].addLayer(a)):(r.lat!==b.lat||r.lng!==b.lng)&&a.setLatLng([b.lat,b.lng])}},!0)}}}]),angular.module("leaflet-directive").factory("leafletHelpers",["$q","$log",function(a,b){function c(a,c){var d,e;if(angular.isDefined(c))d=c;else if(0===Object.keys(a).length)d="main";else if(Object.keys(a).length>=1)for(e in a)a.hasOwnProperty(e)&&(d=e);else 0===Object.keys(a).length?d="main":b.error("[AngularJS - Leaflet] - You have more than 1 map on the DOM, you must provide the map ID to the leafletData.getXXX call");return d}function d(b,d){var e,f=c(b,d);return angular.isDefined(b[f])&&b[f].resolvedDefer!==!0?e=b[f].defer:(e=a.defer(),b[f]={defer:e,resolvedDefer:!1}),e}return{isEmpty:function(a){return 0===Object.keys(a).length},isUndefinedOrEmpty:function(a){return angular.isUndefined(a)||null===a||0===Object.keys(a).length},isDefined:function(a){return angular.isDefined(a)&&null!==a},isNumber:function(a){return angular.isNumber(a)},isString:function(a){return angular.isString(a)},isArray:function(a){return angular.isArray(a)},isObject:function(a){return angular.isObject(a)},isFunction:function(a){return angular.isFunction(a)},equals:function(a,b){return angular.equals(a,b)},isValidCenter:function(a){return angular.isDefined(a)&&angular.isNumber(a.lat)&&angular.isNumber(a.lng)&&angular.isNumber(a.zoom)},isValidPoint:function(a){return angular.isDefined(a)&&angular.isNumber(a.lat)&&angular.isNumber(a.lng)},isSameCenterOnMap:function(a,b){var c=b.getCenter(),d=b.getZoom();return a.lat&&a.lng&&c.lat.toFixed(4)===a.lat.toFixed(4)&&c.lng.toFixed(4)===a.lng.toFixed(4)&&d===a.zoom?!0:!1},safeApply:function(a,b){var c=a.$root.$$phase;"$apply"===c||"$digest"===c?a.$eval(b):a.$apply(b)},obtainEffectiveMapId:c,getDefer:function(a,b){var e,f=c(a,b);return e=angular.isDefined(a[f])&&a[f].resolvedDefer!==!1?a[f].defer:d(a,b)},getUnresolvedDefer:d,setResolvedDefer:function(a,b){var d=c(a,b);a[d].resolvedDefer=!0},AwesomeMarkersPlugin:{isLoaded:function(){return angular.isDefined(L.AwesomeMarkers)&&angular.isDefined(L.AwesomeMarkers.Icon)?!0:!1},is:function(a){return this.isLoaded()?a instanceof L.AwesomeMarkers.Icon:!1},equal:function(a,b){return this.isLoaded()&&this.is(a)?angular.equals(a,b):!1}},PolylineDecoratorPlugin:{isLoaded:function(){return angular.isDefined(L.PolylineDecorator)?!0:!1},is:function(a){return this.isLoaded()?a instanceof L.PolylineDecorator:!1},equal:function(a,b){return this.isLoaded()&&this.is(a)?angular.equals(a,b):!1}},MakiMarkersPlugin:{isLoaded:function(){return angular.isDefined(L.MakiMarkers)&&angular.isDefined(L.MakiMarkers.Icon)?!0:!1},is:function(a){return this.isLoaded()?a instanceof L.MakiMarkers.Icon:!1},equal:function(a,b){return this.isLoaded()&&this.is(a)?angular.equals(a,b):!1}},LabelPlugin:{isLoaded:function(){return angular.isDefined(L.Label)},is:function(a){return this.isLoaded()?a instanceof L.MarkerClusterGroup:!1}},MarkerClusterPlugin:{isLoaded:function(){return angular.isDefined(L.MarkerClusterGroup)},is:function(a){return this.isLoaded()?a instanceof L.MarkerClusterGroup:!1}},GoogleLayerPlugin:{isLoaded:function(){return angular.isDefined(L.Google)},is:function(a){return this.isLoaded()?a instanceof L.Google:!1}},ChinaLayerPlugin:{isLoaded:function(){return angular.isDefined(L.tileLayer.chinaProvider)}},HeatMapLayerPlugin:{isLoaded:function(){return angular.isDefined(L.TileLayer.WebGLHeatMap)}},BingLayerPlugin:{isLoaded:function(){return angular.isDefined(L.BingLayer)},is:function(a){return this.isLoaded()?a instanceof L.BingLayer:!1}},WFSLayerPlugin:{isLoaded:function(){return void 0!==L.GeoJSON.WFS},is:function(a){return this.isLoaded()?a instanceof L.GeoJSON.WFS:!1}},AGSLayerPlugin:{isLoaded:function(){return void 0!==lvector&&void 0!==lvector.AGS},is:function(a){return this.isLoaded()?a instanceof lvector.AGS:!1}},YandexLayerPlugin:{isLoaded:function(){return angular.isDefined(L.Yandex)},is:function(a){return this.isLoaded()?a instanceof L.Yandex:!1}},DynamicMapLayerPlugin:{isLoaded:function(){return void 0!==L.esri&&void 0!==L.esri.dynamicMapLayer},is:function(a){return this.isLoaded()?a instanceof L.esri.dynamicMapLayer:!1}},GeoJSONPlugin:{isLoaded:function(){return angular.isDefined(L.TileLayer.GeoJSON)},is:function(a){return this.isLoaded()?a instanceof L.TileLayer.GeoJSON:!1}},UTFGridPlugin:{isLoaded:function(){return angular.isDefined(L.UtfGrid)},is:function(a){return this.isLoaded()?a instanceof L.UtfGrid:(b.error("[AngularJS - Leaflet] No UtfGrid plugin found."),!1)}},CartoDB:{isLoaded:function(){return cartodb},is:function(){return!0}},Leaflet:{DivIcon:{is:function(a){return a instanceof L.DivIcon},equal:function(a,b){return this.is(a)?angular.equals(a,b):!1}},Icon:{is:function(a){return a instanceof L.Icon},equal:function(a,b){return this.is(a)?angular.equals(a,b):!1}}}}}])}();var app=angular.module("IF",["ngRoute","tidepoolsFilters","tidepoolsServices","ngSanitize","leaflet-directive","angularFileUpload","IF-directives","ngAnimate","mgcrea.ngStrap","once","angularSpectrumColorpicker","ui.slider"]).config(function(a,b,c,d,e){var f=(d.classNameFilter(/if-animate/i),function(a,b,c,d,e){var f=a.defer();return c.get("/api/user/loggedin").success(function(a){"0"!==a?(a._id&&(e.userID=a._id),e.userName=a.facebook?a.facebook.name:a.twitter?a.twitter.displayName:a.meetup?a.meetup.displayName:a.local?a.local.email:"Me",e.showLogout=!0,b(f.resolve,0)):(e.showLogout=!1,e.message="You need to log in.",b(function(){f.reject()},0),d.url("/login"))}),f.promise});c.responseInterceptors.push(function(a,b){return function(c){return c.then(function(a){return a},function(c){return 401===c.status&&b.url("/login"),a.reject(c)})}}),a.when("/",{templateUrl:"components/nearby/nearby.html",controller:WorldRouteCtrl}).when("/nearby",{templateUrl:"components/nearby/nearby.html",controller:WorldRouteCtrl}).when("/login",{templateUrl:"components/auth/login.html",controller:LoginCtrl}).when("/forgot",{templateUrl:"components/auth/forgot.html",controller:ForgotCtrl}).when("/reset/:token",{templateUrl:"components/auth/change-password.html",controller:ResetCtrl}).when("/signup",{templateUrl:"components/auth/signup.html",controller:SignupCtrl}).when("/profile",{templateUrl:"components/auth/profile.html",controller:ProfileCtrl,resolve:{loggedin:f}}).when("/profile/:incoming",{templateUrl:"components/auth/profile.html",controller:ProfileCtrl,resolve:{loggedin:f}}).when("/auth/:type",{templateUrl:"components/auth/loading.html",controller:resolveAuth}).when("/auth/:type/:callback",{templateUrl:"components/auth/loading.html",controller:resolveAuth}).when("/w/:worldURL",{templateUrl:"components/world/world.html",controller:WorldController}).when("/w/:worldURL/upcoming",{templateUrl:"components/world/upcoming.html",controller:WorldController}).when("/w/:worldURL/:landmarkURL",{templateUrl:"components/world/landmark.html",controller:LandmarkController}).when("/w/:worldURL/category/:category",{templateUrl:"components/world/category.html",controller:CategoryController}).when("/list/:category/:filter",{templateUrl:"partials/list.html",controller:ListCtrl}).when("/newworld",{templateUrl:"components/editor/world-maker.html",controller:WorldMakerCtrl,resolve:{loggedin:f}}).when("/newworld/:projectID",{templateUrl:"components/editor/world-maker.html",controller:WorldMakerCtrl,resolve:{loggedin:f}}).when("/edit/w/:worldURL/landmarks",{templateUrl:"components/editor/landmark-editor.html",controller:LandmarkEditorController,resolve:{loggedin:f}}).when("/edit/w/:worldURL/",{templateUrl:"components/edit/edit_world.html",controller:EditController,resolve:{loggedin:f}}).when("/edit/w/:worldURL/:view",{templateUrl:"components/edit/edit_world.html",controller:EditController,resolve:{loggedin:f}}).when("/edit/walkthrough/:_id",{templateUrl:"components/edit/walkthrough/walkthrough.html",controller:WalkthroughController,resolve:{loggedin:f}}).when("/meetup",{templateUrl:"components/tour/meetup.html",controller:MeetupController}).when("/search/:searchQuery",{templateUrl:"components/search/search.html",controller:SearchController}).when("/twitter/:hashTag",{templateUrl:"partials/tweet-list.html",controller:TweetlistCtrl}).when("/instagram/:hashTag",{templateUrl:"partials/insta-list.html",controller:InstalistCtrl}).when("/chat/:worldID",{templateUrl:"partials/chat.html",controller:ChatCtrl}).otherwise({redirectTo:"/"}),b.html5Mode(!0),angular.extend(e.defaults,{animation:"am-fade",placement:"right",delay:{show:"0",hide:"250"}})}).run(function(a,b,c){a.message="",a.logout=function(){a.message="Logged out.",b.get("/api/user/logout"),a.showLogout=!1,c.url("/")}});_={},_.debounce=function(a,b,c){var d,e,f,g,h,i=function(){var j=_.now()-g;b>j&&j>=0?d=setTimeout(i,b-j):(d=null,c||(h=a.apply(f,e),d||(f=e=null)))};return function(){f=this,e=arguments,g=_.now();var j=c&&!d;return d||(d=setTimeout(i,b)),j&&(h=a.apply(f,e),f=e=null),h}},_.now=Date.now||function(){return(new Date).getTime()},angular.module("IF-directives",[]).directive("myPostRepeatDirective",function(){return function(a){if(a.$last){var b=$("#card-container");b.isotope({itemSelector:".iso-card"})}}}).directive("ngEnter",function(){return function(a,b,c){b.bind("keydown keypress",function(b){13===b.which&&(a.$apply(function(){a.$eval(c.ngEnter)}),b.preventDefault())})}}),angular.module("IF-directives",[]).directive("fitFont",function(){return{restrict:"A",link:function(a,b){function c(a){return a.offsetHeight<a.scrollHeight||a.offsetWidth<a.scrollWidth?!0:!1}function d(){for(;c(f)&&e>12;)e--,b.css("font-size",e+"px")}var e=parseInt(b.css("font-size")),f=b[0],g=[];g.push(a.$watch(function(){return f.clientWidth},function(a,g){if(a!=g)if(g>a)d();else{do e++,b.css("font-size",e+"px");while(0==c(f));d()}})),g.push(a.$watch("world.name",function(){d()}))}}}),app.directive("ryFocus",function(){return{restrict:"A",scope:{shouldFocus:"=ryFocus"},link:function(a,b){a.$watch("shouldFocus",function(a,c){1!=a||c?0==a&&c&&b[0].blur():b[0].focus()})}}}),angular.module("tidepoolsFilters",[]).filter("hashtag",function(){return function(a){return a.replace(/[#]+[A-Za-z0-9-_]+/g,function(a){var b=a.replace("#","");return a.link("#/talk/"+b)})}}).filter("youtubestrip",function(){return function(a){if(a){var b=a.replace(/^[^_]*=/,"");return b}}}).filter("url",function(){return function(a){var b=/(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gi;return a.replace(b,function(a){return'<a href="'+a+'">'+a+"</a>"})}}).filter("unsafe",function(a){return function(b){return a.trustAsHtml(b)}}).filter("httpsify",function(){return function(a){return a.replace(/^http:\/\//i,"https://")}}).filter("userName",function(){return function(a){var b;return"string"==typeof a?(b=a.indexOf("@"),-1!=b?a.substr(0,b):a):a}}).filter("datetime",function(a){return function(b){if(null==b)return"";var c=a("date")(new Date(b),"hh:mm a - MMM dd, yyyy");return c.toUpperCase()}});var userLat,userLon,global_mapCenter,local_icons={defaultIcon:{},yellowIcon:{iconUrl:"img/marker-icon.png",shadowUrl:"img/marker-shadow.png",iconSize:[25,41],shadowSize:[41,41],iconAnchor:[12,40],shadowAnchor:[12,40],popupAnchor:[0,-40]},leafIcon:{iconUrl:"img/leaf-green.png",shadowUrl:"img/leaf-shadow.png",iconSize:[38,95],shadowSize:[50,64],iconAnchor:[22,94],shadowAnchor:[4,62],popupAnchor:[-3,-76]},orangeLeafIcon:{iconUrl:"img/leaf-orange.png",shadowUrl:"img/leaf-shadow.png",iconSize:[38,95],shadowSize:[50,64],iconAnchor:[22,94],shadowAnchor:[4,62],popupAnchor:[-3,-76]},divIcon:{type:"div",iconSize:[200,0],popupAnchor:[0,0],html:"Using <strong>Bold text as an icon</strong>:"}},tilesDict={openstreetmap:{url:"https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",options:{attribution:'&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}},mapbox:{url:"https://{s}.tiles.mapbox.com/v3/interfacefoundry.ig1oichl/{z}/{x}/{y}.png",options:{attribution:"IF",minZoom:1,maxZoom:23,reuseTiles:!0}},aicp:{url:"1.0.0/aicpweek/{z}/{x}/{y}.png",options:{minZoom:16,maxZoom:23,reuseTiles:!0}},urban:{url:"https://{s}.tiles.mapbox.com/v3/interfacefoundry.ig6a7dkn/{z}/{x}/{y}.png",option:{attribution:"IF",minZoom:1,maxZoom:19,reuseTiles:!0}},fairy:{url:"https://{s}.tiles.mapbox.com/v3/interfacefoundry.ig9jd86b/{z}/{x}/{y}.png",option:{attribution:"IF",minZoom:1,maxZoom:23,reuseTiles:!0}},sunset:{url:"https://{s}.tiles.mapbox.com/v3/interfacefoundry.ig6f6j6e/{z}/{x}/{y}.png",option:{attribution:"IF",minZoom:1,maxZoom:23,reuseTiles:!0}},arabesque:{url:"https://{s}.tiles.mapbox.com/v3/interfacefoundry.ig67e7eb/{z}/{x}/{y}.png",option:{attribution:"IF",minZoom:1,maxZoom:23,reuseTiles:!0}}},mapSelect="cloud",global_hashtag="#HappyHourShowcase",eventCategories=["lecture","show","award"],placeCategories=["food","bars","sponsors","washrooms","exhibits","smoking"],globalEditLoc={};"undefined"!=typeof module&&"undefined"!=typeof module.exports&&(module.exports.hashtag=global_hashtag);var mainWindow,he;L.AreaSelect=L.Class.extend({includes:L.Mixin.Events,options:{width:200,height:300,keepAspectRatio:!1},initialize:function(a){L.Util.setOptions(this,a),this.options.width>1e3||this.options.height>1e3?(this._width=this.options.width/8,this._height=this.options.height/8):(this._width=this.options.width,this._height=this.options.height)},addTo:function(a){return this.map=a,this._createElements(),this._render(),this},getBounds:function(){var a=this.map.getSize(),b=new L.Point,c=new L.Point;c.x=Math.round((a.x-this._width)/2),b.y=Math.round((a.y-this._height)/2),b.x=a.x-c.x,c.y=a.y-b.y;var d=this.map.containerPointToLatLng(c),e=this.map.containerPointToLatLng(b);return new L.LatLngBounds(d,e)},remove:function(){this.map.off("moveend",this._onMapChange),this.map.off("zoomend",this._onMapChange),this.map.off("resize",this._onMapResize),this._container.remove()},_createElements:function(){this._container||(this._container=L.DomUtil.create("div","leaflet-areaselect-container",this.map._controlContainer),this._topShade=L.DomUtil.create("div","leaflet-areaselect-shade",this._container),this._bottomShade=L.DomUtil.create("div","leaflet-areaselect-shade",this._container),this._leftShade=L.DomUtil.create("div","leaflet-areaselect-shade",this._container),this._rightShade=L.DomUtil.create("div","leaflet-areaselect-shade",this._container),this._nwHandle=L.DomUtil.create("div","leaflet-areaselect-handle",this._container),this._swHandle=L.DomUtil.create("div","leaflet-areaselect-handle",this._container),this._neHandle=L.DomUtil.create("div","leaflet-areaselect-handle",this._container),this._seHandle=L.DomUtil.create("div","leaflet-areaselect-handle",this._container),this._setUpHandlerEvents(this._nwHandle),this._setUpHandlerEvents(this._neHandle,-1,1),this._setUpHandlerEvents(this._swHandle,1,-1),this._setUpHandlerEvents(this._seHandle,-1,-1),this.map.on("moveend",this._onMapChange,this),this.map.on("zoomend",this._onMapChange,this),this.map.on("resize",this._onMapResize,this),this.fire("change"))},_setUpHandlerEvents:function(a,b,c){function d(f){function g(a){if(e.options.keepAspectRatio){var d=(e._height>=e._width?l.y:l.y*(1/k))-30;e._height+=2*(j-a.originalEvent.y)*c,e._height=Math.max(30,e._height),e._height=Math.min(d,e._height),e._width=e._height*k}else e._width+=2*(i-a.originalEvent.x)*b,e._height+=2*(j-a.originalEvent.y)*c,e._width=Math.max(30,e._width),e._height=Math.max(30,e._height),e._width=Math.min(l.x-30,e._width),e._height=Math.min(l.y-30,e._height);i=a.originalEvent.x,j=a.originalEvent.y,e._render()}function h(){L.DomEvent.removeListener(e.map,"mouseup",h),L.DomEvent.removeListener(e.map,"mousemove",g),L.DomEvent.addListener(a,"mousedown",d),e.fire("change")}f.stopPropagation(),L.DomEvent.removeListener(this,"mousedown",d);var i=f.x,j=f.y,k=e._width/e._height,l=e.map.getSize();L.DomEvent.addListener(e.map,"mousemove",g),L.DomEvent.addListener(e.map,"mouseup",h)}b=b||1,c=c||1;var e=this;L.DomEvent.addListener(a,"mousedown",d)},_onMapResize:function(){this._render()},_onMapChange:function(){this.fire("change")},_render:function(){function a(a,b){a.style.width=b.width+"px",a.style.height=b.height+"px",a.style.top=b.top+"px",a.style.left=b.left+"px",a.style.bottom=b.bottom+"px",a.style.right=b.right+"px"}var b=this.map.getSize(),c=Math.round(this._nwHandle.offsetWidth/2),d=Math.round((b.y-this._height)/2),e=Math.round((b.x-this._width)/2);
a(this._topShade,{width:b.x,height:d,top:0,left:0}),a(this._bottomShade,{width:b.x,height:d,bottom:0,left:0}),a(this._leftShade,{width:e,height:b.y-2*d,top:d,left:0}),a(this._rightShade,{width:e,height:b.y-2*d,top:d,right:0}),a(this._nwHandle,{left:e-c,top:d-7}),a(this._neHandle,{right:e-c,top:d-7}),a(this._swHandle,{left:e-c,bottom:d-7}),a(this._seHandle,{right:e-c,bottom:d-7})}}),L.areaSelect=function(a){return new L.AreaSelect(a)};var res;angular.module("tidepoolsServices",["ngResource"]).factory("Landmark",["$resource","$http",function(a){var b={count:{method:"PUT",params:{_id:"count"}},distinct:{method:"PUT",params:{_id:"distinct"}},find:{method:"PUT",params:{_id:"find"},isArray:!0},group:{method:"PUT",params:{_id:"group"},isArray:!0},mapReduce:{method:"PUT",params:{_id:"mapReduce"},isArray:!0},aggregate:{method:"PUT",params:{_id:"aggregate"},isArray:!0},del:{method:"DELETE",params:{_id:"del"},isArray:!1}};return res=a("/api/landmarks/:_id:id",{},b)}]).factory("World",["$resource","$http","leafletData",function(a){var b={count:{method:"PUT",params:{_id:"count"}},distinct:{method:"PUT",params:{_id:"distinct"}},find:{method:"PUT",params:{_id:"find"},isArray:!0},group:{method:"PUT",params:{_id:"group"},isArray:!0},mapReduce:{method:"PUT",params:{_id:"mapReduce"},isArray:!0},aggregate:{method:"PUT",params:{_id:"aggregate"},isArray:!0},del:{method:"DELETE",params:{_id:"del"},isArray:!0}};return res=a("/api/worlds/:_id:id",{},b)}]).factory("db",["$resource","$http",function(a){var b={count:{method:"PUT",params:{_id:"count"}},distinct:{method:"PUT",params:{_id:"distinct"}},find:{method:"PUT",params:{_id:"find"},isArray:!0},group:{method:"PUT",params:{_id:"group"},isArray:!0},mapReduce:{method:"PUT",params:{_id:"mapReduce"},isArray:!0},aggregate:{method:"PUT",params:{_id:"aggregate"},isArray:!0},create:{method:"POST",params:{_id:"create"},isArray:!0},locsearch:{method:"GET",params:{_id:"locsearch"},isArray:!0}},c={};return c.worlds=a("/api/worlds/:_id",{},b),c.landmarks=a("api/landmarks/:_id:id",{},b),c.styles=a("api/styles/:_id",{},b),c.projects=a("api/projects/:_id",{},b),c.tweets=a("api/tweets/:_id",{},b),c.instagrams=a("api/instagrams/:_id",{},b),c}]).factory("apertureService",["leafletData","mapManager",function(a,b){var c={off:!0,state:"aperture-off",navfix:"navfix"},d=b;return c.toggle=function(a){"aperture-full"!=c.state?(c.off=!1,c.navfix="","half"==a&&c.set("half"),"full"==a&&c.set("full")):(c.off=!0,c.state="aperture-off",c.navfix="navfix")},c.set=function(a){switch(a){case"off":c.off=!0,c.state="aperture-off",c.navfix="navfix",d.apertureUpdate("aperture-off");break;case"third":c.off=!1,c.state="aperture-third",c.navfix="",d.apertureUpdate("aperture-third");break;case"half":c.off=!1,c.state="aperture-half",c.navfix="",d.apertureUpdate("aperture-half");break;case"full":c.off=!1,c.state="aperture-full",c.navfix="",d.apertureUpdate("aperture-full")}},c}]).factory("alertManager",["$timeout",function(a){var b={list:[]};return b.addAlert=function(c,d,e){b.list=[];var f;switch(c){case"success":f="alert-success";break;case"info":f="alert-info";break;case"warning":f="alert-warning";break;case"danger":f="alert-danger"}var g=b.list.push({"class":f,msg:d});e&&a(function(){b.list.splice(g-1,1)},3e3)},b.closeAlert=function(a){b.list.splice(a,1)},b}]).factory("socket",function(a){var b=io.connect();return{on:function(c,d){b.on(c,function(){var c=arguments;a.$apply(function(){d.apply(b,c)})})},emit:function(c,d,e){b.emit(c,d,function(){var c=arguments;a.$apply(function(){e&&e.apply(b,c)})})}}}),angular.module("tidepoolsServices").factory("ifGlobals",[function(){var a={kinds:{Convention:{name:"Convention",hasTime:!0,img:"convention.png"},Event:{name:"Event",hasTime:!0,img:"event.png"},Neighborhood:{name:"Neighborhood",hasTime:!1,img:"neighborhood.png"},Venue:{name:"Venue",hasTime:!1,img:"venue.png"},Park:{name:"Park",hasTime:!1,img:"park.png"},Retail:{name:"Retail",hasTime:!1,img:"retail.png"},Campus:{name:"Campus",hasTime:!1,img:"campus.png"},Home:{name:"Home",hasTime:!1,img:"home.png"},Other:{name:"Other",hasTime:!1,img:"other.png"}}};return a}]),angular.module("tidepoolsServices").factory("mapManager",["leafletData","$rootScope",function(a,b){function c(){a.getMap().then(function(a){setTimeout(function(){a.invalidateSize()},400)})}var d={center:{lat:42,lng:-83,zoom:14},markers:{},layers:{baselayers:{baseMap:{name:"Sunset",url:"https://{s}.tiles.mapbox.com/v3/interfacefoundry.ig6f6j6e/{z}/{x}/{y}.png",type:"xyz",top:!0,maxZoom:25}},overlays:{}},paths:{},maxbounds:{},defaults:{controls:{layers:{visible:!1,position:"bottomright",collapsed:!0}},zoomControlPosition:"bottomleft"}};return d.setCenter=function(b,c,e){function f(b,c,e,f){var g,h,i=Math.max(document.documentElement.clientHeight,window.innerHeight||0),j=Math.max(document.documentElement.clientWidth,window.innerWidth||0);a.getMap().then(function(a){g=a.project([b[1],b[0]],c).add([j*e,i*f]),h=a.unproject(g,c),angular.extend(d.center,{lat:h.lat,lng:h.lng,zoom:c}),d.refresh()})}switch(d._actualCenter=b,d._z=c,e){case"aperture-half":f(b,c,0,.5);break;case"aperture-third":f(b,c,0,.35);break;case"editor":f(b,c,-.2,0);break;default:angular.extend(d.center,{lat:b[1],lng:b[0],zoom:c}),d.refresh()}},d.apertureUpdate=function(a){d._actualCenter&&d._z&&d.setCenter(d._actualCenter,d._z,a)},d.resetMap=function(){d.removeAllMarkers(),d.removeAllPaths(),d.removeOverlays(),d.removeCircleMask(),d.removePlaceImage(),d.refresh()},d.addMarker=function(a,b,c){if(d.markers.hasOwnProperty(a)){if(1==c)return!1;d.markers[a]=b}else d.markers[a]=b;return!0},d.getMarker=function(a){return d.markers.hasOwnProperty(a)?d.markers[a]:!1},d.removeMarker=function(a){return d.markers.hasOwnProperty(a)?(delete d.markers[a],!0):!1},d.removeAllMarkers=function(){d.markers={}},d.setMarkerMessage=function(a,b){return d.markers.hasOwnProperty(a)?(angular.extend(d.markers[a],{message:b}),!0):!1},d.setMarkerFocus=function(a){return d.markers.hasOwnProperty(a)?(angular.forEach(d.markers,function(a){a.focus=!1}),d.markers[a].focus=!0,!0):!1},d.addPath=function(a,b,c){return d.paths.hasOwnProperty(a)&&1==c?!1:(d.paths[a]=b,d.paths[a])},d.removeAllPaths=function(){d.paths={}},d.setTiles=function(a){angular.extend(d.tiles,tilesDict[a]),c()},d.setMaxBounds=function(b,c){a.getMap().then(function(a){a.setMaxBounds([[b[0],b[1]],[c[0],c[1]]]),d.refresh()})},d.setMaxBoundsFromPoint=function(b,c){return a.getMap().then(function(a){setTimeout(function(){a.setMaxBounds([[b[0]-c,b[1]-c],[b[0]+c,b[1]+c]])},400),d.refresh()}),!0},d.refresh=function(){c()},d.setBaseLayer=function(a){d.layers.baselayers={},d.layers.baselayers[a]={name:"newBaseMap",url:a,type:"xyz",layerParams:{},layerOptions:{minZoom:1,maxZoom:19}}},d.setBaseLayerFromID=function(a){d.setBaseLayer("https://{s}.tiles.mapbox.com/v3/"+a+"/{z}/{x}/{y}.png")},d.addOverlay=function(a,b,c){c.maxZoom>19&&(c.maxZoom=19),c.zIndex=10,d.layers.overlays[b]={name:b,type:"xyz",url:"http://107.170.180.141/maps/"+a+"/{z}/{x}/{y}.png",layerOptions:c,visible:!0,opacity:.8}},d.removeOverlays=function(){d.layers.overlays={},d.refresh()},d.addCircleMaskToMarker=function(c,e,f){d.circleMaskLayer=new L.IFCircleMask(d.markers[c],150,f),a.getMap().then(function(a){a.addLayer(d.circleMaskLayer),b.$on("leafletDirectiveMarker.dragend",function(){d.circleMaskLayer._draw()})})},d.setCircleMaskState=function(a){d.circleMaskLayer&&d.circleMaskLayer._setState(a)},d.removeCircleMask=function(){d.circleMaskLayer&&a.getMap().then(function(a){a.removeLayer(d.circleMaskLayer)})},d.placeImage=function(b,c){return d.placeImageLayer=new L.IFPlaceImage(c,d.markers[b]),a.getMap().then(function(a){a.addLayer(d.placeImageLayer)}),function(a){d.placeImageLayer.setScale(a)}},d.setPlaceImageScale=function(a){d.placeImageLayer.setScale(a)},d.removePlaceImage=function(){d.placeImageLayer&&a.getMap().then(function(a){a.removeLayer(d.placeImageLayer)})},d.getPlaceImageBounds=function(){return d.placeImageLayer?d.placeImageLayer.getBounds():void 0},d}]),angular.module("tidepoolsServices").factory("styleManager",[function(){var a={navBG_color:"rgba(0,188,212,0.96)"};return a.resetNavBG=function(){a.navBG_color="rgba(0,188,212,0.96)"},a}]),angular.module("tidepoolsServices").factory("worldTree",["$cacheFactory","$q","World","db",function(a,b,c,d){var e={worldCache:a("worlds"),styleCache:a("styles"),landmarkCache:a("landmarks")};return e.getWorld=function(a){function d(){c.get({id:a},function(a){a.err?f.reject(a.err):(e.worldCache.put(a.world.id,a.world),e.styleCache.put(a.style._id,a.style),f.resolve(a))})}var f=b.defer(),g=e.worldCache.get(a);if(g&&g.style){var h=e.styleCache.get(g.style.styleID);h?f.resolve({world:g,style:h}):d()}else d();return f.promise},e.getLandmarks=function(a){var c=b.defer(),f=e.landmarkCache.get(a);return f?c.resolve(f):d.landmarks.query({queryFilter:"all",parentID:a},function(b){b.err?c.reject(b.err):(e.landmarkCache.put(a,b),c.resolve(b))}),c.promise},e}]);var themeDict={urban:{name:"urban",bodyBG_color:"#80DEEA",cardBG_color:"#FFFFFF",titleBG_color:"#00BCD4",navBG_color:"rgba(0, 172, 193, 0.8)",worldTitle_color:"#FFF",landmarkTitle_color:"#304FFE",categoryTitle_color:"#536DFE"},sunset:{name:"sunset",bodyBG_color:"#FFE0B2",cardBG_color:"#FFFFFF",titleBG_color:"#FF9800",navBG_color:"rgba(245, 124, 0, 0.8)",worldTitle_color:"#FFF",landmarkTitle_color:"#FF4081",categoryTitle_color:"#F48FB1"},fairy:{name:"fairy",bodyBG_color:"#7E57C2",cardBG_color:"#FFFFFF",titleBG_color:"#673AB7",navBG_color:"rgba(81, 45, 168, 0.8)",worldTitle_color:"#FFF",landmarkTitle_color:"#FF5722",categoryTitle_color:"#D1C4E9"},arabesque:{name:"arabesque",bodyBG_color:"#C5CAE9",cardBG_color:"#FFFFFF",titleBG_color:"#3F51B5",navBG_color:"rgba(57, 73, 171, 0.8)",worldTitle_color:"#FFF",landmarkTitle_color:"#FF4081",categoryTitle_color:"#F48FB1"}};TweetlistCtrl.$inject=["$location","$scope","db","$rootScope","$routeParams","apertureService"],InstalistCtrl.$inject=["$location","$scope","db","$rootScope","$routeParams","apertureService"],TalktagCtrl.$inject=["$location","$scope","$routeParams","db","$rootScope"],MenuCtrl.$inject=["$location","$scope","db","$routeParams","$rootScope"],ListCtrl.$inject=["$location","$scope","db","$routeParams","$rootScope"],WorldViewCtrl.$inject=["World","$routeParams","$scope","db","$location","$timeout","leafletData","$route","$rootScope"],LandmarkViewCtrl.$inject=["Landmark","$routeParams","$scope","db","$location","$timeout","leafletData","$route","$rootScope","$sce"],AwardsCtrl.$inject=["$location","$scope","db","$timeout","leafletData","$rootScope"],LecturesCtrl.$inject=["$location","$scope","db","$timeout","leafletData","$rootScope"],ShowCtrl.$inject=["$location","$scope","db","$timeout","leafletData","$rootScope"];
>>>>>>> FETCH_HEAD
