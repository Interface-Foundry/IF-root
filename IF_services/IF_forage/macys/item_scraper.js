...
function getInventory(itemData, stores) {
    ...
    //MACYS.pdp.upcmap["1070209"] = [{
    // map to size + color, query each per item
    //http://www1.macys.com/api/store/v2/stores/?upcNumber=887873510306&_fields=name,locationNumber,inventories,schedule,address,attributes
