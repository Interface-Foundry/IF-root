...
function getItem() {
    ...
    return new Promise(function(resolve, reject) {
        var url = 'http://shop.nordstrom.com/s/canada-goose-trillium-parka-with-genuine-coyote-fur-trim/3236693';
        ...
        var options = {
            url: 'http://shop.nordstrom.com/s/canada-goose-trillium-parka-with-genuine-coyote-fur-trim/3236693',
            headers: {
        ...
        request(options, function(error, response, body) {
            if ((!error) && (response.statusCode == 200)) {
                ...
                //http://shop.nordstrom.com/es/GetStoreAvailability?styleid=3236693&type=Style&instoreavailability=true&radius=25&postalcode=10002&format=json
